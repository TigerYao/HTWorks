    ...
    private void initWebView() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.startsWith("ztk://course/detail")){

                    Intent intent = new Intent();
                    intent.setAction(StartChatUtil.PRODUCT_ACTION);
                    //intent.setAction("com.huatu.handheld_huatu.productshow");
                    // intent.setComponent(new ComponentName(getApplicationContext(), StartChatUtil.PRODUCT_ACTION));
                    intent.setData(Uri.parse(url.replace("ztk:","product:")));
                ...
                if (url.contains("weixin://wap/pay?")) {
                    try{
                       // Log.d(TAG,"intent pay");
                        ...
                        Toast.makeText(WebViewActivity.this,"请下载安装最新版微信",Toast.LENGTH_SHORT).show();
                    }
                }
                return false;
            }
