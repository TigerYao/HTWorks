package com.huatu.handheld_huatu.view.swiperecyclerview;
...
import com.huatu.handheld_huatu.business.play.fragment.TeacherJudgeListFragment;
import com.huatu.handheld_huatu.utils.ToastUtils;
import com.huatu.handheld_huatu.view.swiperecyclerview.refresh.ArrowRefreshHeader;
import com.huatu.handheld_huatu.view.swiperecyclerview.refresh.IMoreFooter;
import com.huatu.handheld_huatu.view.swiperecyclerview.refresh.IRefreshHeader;
import com.huatu.handheld_huatu.view.swiperecyclerview.refresh.LoadingMoreFooter;
import com.huatu.handheld_huatu.view.swiperecyclerview.refresh.ProgressStyle;
...
//            int head_foot_items_Count = layoutManager.getItemCount();
            int ic=layoutManager.getItemCount();
            int cc=layoutManager.getChildCount();
            int st=mRefreshHeader.getState();
            //解决屏幕不满足一屏无法加载更多的问题layoutManager.getItemCount() > layoutManager.getChildCount()
            if (layoutManager.getChildCount() > 0
                    && lastVisibleItemPosition >= layoutManager.getItemCount() - 1
                    && layoutManager.getItemCount() > layoutManager.getChildCount()
                    && !isNoMore
                    && isEnabledScroll
                    && mRefreshHeader.getState() != IRefreshHeader.STATE_REFRESHING) {
                isLoadingData = true;
