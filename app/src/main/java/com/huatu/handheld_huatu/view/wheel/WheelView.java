...
public class WheelView extends View {
	...
	public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            dividerColor = a.getColor(R.styleable.wheelview_dividerColor1,dividerColor);
        }
    ...
    private String getContentText(Object item) {
        ...
        try {
            ...
            contentText=cultString(contentText,5);
    ...
    private static String cultString(String str, int len) {
