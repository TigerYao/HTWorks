...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.one_and_a_half_grid_unit), 0, 10,
                0);
        setClickable(true);

        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.selector);

        setBackground(ContextCompat.getDrawable(context,R.drawable.sc_sign_up_spinner_bg));
        ...
        listView.setDivider(ContextCompat.getDrawable(context,R.color.dddddd));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context,R.drawable.sc_sign_up_spinner_bg));
        } else {
            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.sc_sign_up_spinner_bg));
        }
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.arrow_sujob);
...
//        setArrowDrawableOrHide(arrowDrawable);
    ...
    public void setArrowDrawable(int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.arrow_sujob);
        setArrowDrawableOrHide(arrowDrawable);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int popHeight=listView.getMeasuredHeight() - getMeasuredHeight() - dropDownListPaddingBottom;
        if(popHeight>getResources().getDimensionPixelSize(R.dimen.dp174)){
            popHeight=getResources().getDimensionPixelSize(R.dimen.dp174);
        }else if(popHeight<getResources().getDimensionPixelSize(R.dimen.dp174)){
            popHeight=getResources().getDimensionPixelSize(R.dimen.dp174);
        }
        popupWindow.setHeight(popHeight);
        setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec),getResources().getDimensionPixelSize(R.dimen.dp33));
    }
