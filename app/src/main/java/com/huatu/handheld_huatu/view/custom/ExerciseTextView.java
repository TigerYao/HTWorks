 ...
 */
public class ExerciseTextView extends android.support.v7.widget.AppCompatTextView implements ISelectInfo {
    ...
    public CusDraw mCusDraw;                            // 旧的，申论中选中和背景绘制

    private TextSelectManager.SelectTools selectTools;  // 新的，行测中使用的文字选中和背景绘制


    public TextSelectManager.SelectTools getSelectTool(){
        return selectTools;
    }
...
/*     @Override
    public void onDetachedFromWindow() {
        ...
        if (null != this.getTag(R.id.glide_tag_id_exercise)) {
            if (this.getTag(R.id.glide_tag_id_exercise) instanceof GlideImageV4Getter) {
                GlideImageV4Getter tmpGetter = (GlideImageV4Getter) this.getTag(R.id.glide_tag_id_exercise);
                tmpGetter.clear(false);

                //LogUtils.e("ExerciseTextView","clear");
            }
        }
    }*/
    ...
    public void setHtmlSource(String source) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            mSpanned = Html.fromHtml(htmlSource, Html.FROM_HTML_MODE_COMPACT,
                    new GlideImageV4Getter(htmlSource, ExerciseTextView.this, getContext()), new ImgTagHandler(true));
        } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 这里是新的选中和背景绘制
        if (selectTools != null && selectTools.textStyleDraw != null) {
            selectTools.textStyleDraw.onDraw(selectTools, canvas);
        }
    }
