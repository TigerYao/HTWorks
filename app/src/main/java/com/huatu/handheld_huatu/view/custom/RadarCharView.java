...
public class RadarCharView extends View {
    ...
    private       float                        ratio;
    private       float                        axisMaxInternal = 200; //轴长度
    ...
    private void init() {
        paintColor = new int[]{getResources().getColor(R.color.red002),
                ...
                getResources().getColor(R.color.common_part_style_red_color),
                getResources().getColor(R.color.common_arena_gray_color),
                getResources().getColor(R.color.supper_button),
                getResources().getColor(R.color.logistic_green_color),
                getResources().getColor(R.color.supper_hint_color),
                getResources().getColor(R.color.green003),
                getResources().getColor(R.color.purple),
                getResources().getColor(R.color.blue002),
                getResources().getColor(R.color.black),
                ...
                getResources().getColor(R.color.supper_button),
                getResources().getColor(R.color.logistic_green_color),
                getResources().getColor(R.color.report_card_time_out)

        };
        textSize = DisplayUtil.sp2px(10);
        textPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        textPaint.setTextSize(textSize);
        textPaint.density = DisplayUtil.getDensity();
        paint = createPaint(Color.BLACK);
        axisMaxInternal = DisplayUtil.getScreenWidth() * 0.28f;
    ...
    private void drawValues(Canvas canvas, int count) {
        ...
        path.close();
        mutatePaint(paint, strokeWidth, Paint.Style.FILL);
