package com.huatu.handheld_huatu.view.bottomdialog;
...
import com.huatu.handheld_huatu.mvpmodel.me.YwpAddressBean;
...
/**
 * Created by chq on 2018/8/6.
 */

public class AddressPickerView extends RelativeLayout implements View.OnClickListener {

    // recyclerView 选中Item 的颜色
    private int defaultSelectedColor = Color.parseColor("#FF6D73");
    // recyclerView 未选中Item 的颜色
    private int defaultUnSelectedColor = Color.parseColor("#4A4A4A");
    // 确定字体不可以点击时候的颜色
    private int defaultSureUnClickColor = Color.parseColor("#FFFFFF");
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#FFFFFF");
    ...
    private OnAddressPickerCloseListener mOnAddressPickerCloseListener;
    private TextView mTvSure;           // 确定
    private ImageView ivClose;          // 取消
    ...
    private void init(Context context) {
        ...
        // 确定
        mTvSure = (TextView) rootView.findViewById(R.id.tvSure);
...
//         将数据转换为对象
    ...
    // 点取消
    private void close() {
        if (mOnAddressPickerCloseListener != null) {
            mOnAddressPickerCloseListener.onCloseClick();
        }
    }
    ...
    public interface OnAddressPickerSureListener {
        void onSureClick(String address, String province, String city, String district, String provinceCode, String cityCode, String districtCode);
    }

    public interface OnAddressPickerCloseListener {
        void onCloseClick();
    }
    ...
    public void setOnAddressPickerClose(OnAddressPickerCloseListener listener) {
        this.mOnAddressPickerCloseListener = listener;
    }
