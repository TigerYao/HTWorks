...
public abstract class SelectItemAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements View.OnClickListener {
    ...
    public abstract void whenBindViewHolder(VH holder, int position, boolean isSelected);
    ...
    public void onBindViewHolder(VH holder, int position) {
        ...
        whenBindViewHolder(holder, position, isSelected);
    }
