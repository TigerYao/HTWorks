...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private LetterSortAdapter mAdapter;

    public StickyItemDecoration(LetterSortAdapter mAdapter) {
        super();
    ...
    private RecyclerView.ViewHolder getHeader(RecyclerView parent, int position) {
        //创建HeaderViewHolder
        LetterSortAdapter.HeaderHolder holder = mAdapter.onCreateHeaderViewHolder(parent);
