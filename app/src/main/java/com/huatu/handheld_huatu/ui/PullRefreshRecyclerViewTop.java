 ...
 */
public class PullRefreshRecyclerViewTop extends PullToRefreshBase<RecyclerViewTopEx> {
    ...
    public PullRefreshRecyclerViewTop(Context context, Mode mode) {
        super(context, mode);
        //mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public PullRefreshRecyclerViewTop(Context context) {
        super(context);
        //mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public PullRefreshRecyclerViewTop(Context context, AttributeSet attrs) {
        super(context, attrs);
        //mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public PullRefreshRecyclerViewTop(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    @Override
    protected RecyclerViewTopEx createRefreshableView(Context context, AttributeSet attrs) {
        RecyclerViewTopEx recyclerView = new RecyclerViewTopEx(context,attrs);
