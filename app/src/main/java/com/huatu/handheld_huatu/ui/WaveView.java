...
/**
 * Created by cjx on 2018\8\8 0008.
 */
...
/*public class WareView extends View {
    ...
    private int rippleDelay=1000;
    private int rippleDurationTime=600;

    public void startAnimal(int i){

        AnimationSet animationSet = new AnimationSet(true);
        animationSet.setInterpolator(new AccelerateDecelerateInterpolator());
        AlphaAnimation alphaAnimator=new AlphaAnimation(1.0f, 0.7f);

        alphaAnimator.setRepeatCount(ObjectAnimator.INFINITE);
        alphaAnimator.setRepeatMode(ObjectAnimator.RESTART);
        alphaAnimator.setStartOffset(i*rippleDelay);
        alphaAnimator.setDuration(rippleDurationTime);
        animationSet.addAnimation(alphaAnimator);

        ScaleAnimation scaleAnimator = new ScaleAnimation(0.8f, 1.5f, 0.8f, 1.5f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        scaleAnimator.setRepeatCount(ObjectAnimator.INFINITE);
        scaleAnimator.setRepeatMode(ObjectAnimator.RESTART);
        scaleAnimator.setStartOffset(i*rippleDelay);
        scaleAnimator.setDuration(rippleDurationTime);
        animationSet.addAnimation(scaleAnimator);
