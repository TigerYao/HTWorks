...
public class BitmapDecoder {
	...
	public static Bitmap decodeSampledBitmapFromByte(byte[] data) {
		...
		final int screenWidth = DisplayUtil.getScreenWidth();// SystemUtils.getScreenWidth();
		final int screenHeight =DisplayUtil.getScreenHeight();// SystemUtils.getScreenHeight();
