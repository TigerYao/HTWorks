...
public class CheckDetailBean implements Serializable {
  ...
  //  public int inputWordNumMin;                     // 最小录入字数。
   ...
   // public String inscribedName;                    // 落款名称
    ...
    public long   audioId;                               // 名师之声ID
    public String audioToken;                            // 名师之声token
    public List<RemarkEntity> remarkList;               //综合阅卷

    public List<RemarkEntity> deRemarkList;             //扣分项

    public List<SingleQuestionInfoBean.UserMetaInfo> userMeta;
