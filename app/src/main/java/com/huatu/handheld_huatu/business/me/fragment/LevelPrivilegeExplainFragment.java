...
public class LevelPrivilegeExplainFragment extends BaseWebViewFragment {
    public static Bundle getArgs() {
        String webUrl = RetrofitManager.getInstance().getBaseUrl()+"pc/reward/dengjitequan.html" ;
        LogUtils.i("webUrl: " + webUrl);
        Bundle bundle = new Bundle();
        bundle.putString(ARGS_STRING_URL, webUrl);
        bundle.putString(ARGS_STRING_TITLE, "等级特权说明");
