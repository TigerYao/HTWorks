...
public class ConfigUtil {
	...
	// 配置API KEY
	public final static String API_KEY = "uhBbgtq632a1rZwVHFn9lvjtYMJipPTM";

	// 配置帐户ID
	public final static String USERID = "201888D414AA1A23";

	// 配置下载文件路径
	public final static String DOWNLOAD_DIR = "/huatu/CCDownload";
