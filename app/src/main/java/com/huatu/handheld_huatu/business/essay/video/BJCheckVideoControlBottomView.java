...
public class BJCheckVideoControlBottomView implements IPlayerBottomContact.BottomView, View.OnClickListener {
    ...
    BJCheckVideoControlBottomView(View rootView, CheckBJPlayerView mPlayerView) {
