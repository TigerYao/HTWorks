...
/**
 * Created by ht-djd on 2017/9/23.
 * 课程评价列表页面
 */

public class CourseEvaluateActivity extends BaseActivity implements XListView.IXListViewListener, View.OnClickListener {
    ...
    protected void onInitView() {
        ...
        //Log.d("adadadad",classid+"``"+lessionid);
        xlv_pingjia = (XListView) findViewById(R.id.xlv_pingjia);
        teacherEvaluateAdapter = new
                TeacherEvaluateAdapter(CourseEvaluateActivity.this, mEvaluateList);
        xlv_pingjia.setHeaderDividersEnabled(false);
    ...
    private void initDataView(String lessiontitle, String photo_url, String teachername, int star, String score, int flag) {
 ...
 /*       Glide.with(CourseEvaluateActivity.this)
                .load(photo_url)
                .transform(new CircleTransform(CourseEvaluateActivity.this))
...
*/
        ...
        ImageLoad.displaynoCacheUserAvater(CourseEvaluateActivity.this,photo_url,iv_teacher,R.mipmap.user_default_avater);
        if (flag == 1) {
    ...
    private void getData(final boolean isRefresh) {
        ...
        if (TextUtils.isEmpty(classid)||TextUtils.isEmpty(lessionid)){
                ...
                .subscribe(new Subscriber<TeacherPingjiaBean>() {
                    ...
                    public void onNext(TeacherPingjiaBean teacherPingjiaBean) {
                        if (teacherPingjiaBean.getCode() == 1000000) {
                            ...
                            initDataView(lessiontitle, photo_url, teachername, star, score, flag);
                            xlv_pingjia.stopLoadMore();
                            xlv_pingjia.stopRefresh();
    ...
    public static void newIntent(Context context, String classid, String lessionid) {
        Intent intent = new Intent(context, CourseEvaluateActivity.class);
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_pingjia:
                if (NetUtil.isConnected()){
                    LessionEvaluateActivity.newIntent(CourseEvaluateActivity.this, classid, lessionid);
                    finish();
                }else{
