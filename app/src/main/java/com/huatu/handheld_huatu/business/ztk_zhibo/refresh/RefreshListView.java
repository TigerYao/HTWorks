...
public class RefreshListView extends ListView implements OnScrollListener {private static final String TAG = "RefreshListView";
...
private TextView xlistview_footer;
...
private void initFooterView() {
  ...
  fmProgressBar = (ProgressBar) footerView.findViewById(R.id.xlistview_footer_progressbar);
  xlistview_footer = (TextView) footerView.findViewById(R.id.xlistview_footer_hint_textview);
...
public void onScrollStateChanged(AbsListView view, int scrollState) {
  ...
  if (scrollState == SCROLL_STATE_IDLE
    ...
    if (isScrollToBottom && !isLoadingMore) {
      ...
      xlistview_footer.setVisibility(View.GONE);
