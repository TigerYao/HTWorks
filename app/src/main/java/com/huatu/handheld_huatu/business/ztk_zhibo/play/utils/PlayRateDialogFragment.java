...
public class PlayRateDialogFragment extends DialogFragment {

    private final float[] rateArr=new float[]{0.5f,0.75f,1.0f,1.25f,1.5f,1.75f,2f};

    private MyRadioGroup.OnCheckedChangeListener mCheckedListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        actionLayout.setOnCheckedChangeListener(new MyRadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(MyRadioGroup group, int checkedId) {
                if(mCheckedListener != null)
                    mCheckedListener.onCheckedChanged(group, checkedId);
                dismiss();
            }
        });
    ...
    public void setCheckedListener(MyRadioGroup.OnCheckedChangeListener checkedListener) {
