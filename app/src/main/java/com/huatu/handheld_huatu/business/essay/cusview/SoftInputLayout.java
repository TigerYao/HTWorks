...
public class SoftInputLayout extends LinearLayout {
    ...
    public boolean isEmojiLayoutShow = false;
...
//        Log.i(TAG, "onSizeChanged: w:" + w + " h:" + h + " oldw:" + oldw + " oldh:" + oldh);
    ...
    public void showEmojiLayout() {
        ...
        if (mCurrentContentHeight == 0) {
            ...
            if(keyboardHeightFirst==0){
                keyboardHeightFirst=keyboardHeight;
            }
        }

        mCurrentContentHeight = mRawLayoutHeight - keyboardHeight+keyboardHeight -getDefaultEmojiHeight();
        ...
        emojiParams.height = getDefaultEmojiHeight();
    ...
    private int getDefaultEmojiHeight() {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 135, getResources().getDisplayMetrics());
    }
