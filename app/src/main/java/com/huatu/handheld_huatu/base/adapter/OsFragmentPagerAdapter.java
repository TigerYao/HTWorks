...
public abstract class OsFragmentPagerAdapter extends PagerAdapter {

    private final FragmentManager mFragmentManager;
    private FragmentTransaction mCurTransaction;
    private Fragment mCurrentPrimaryItem;

    public OsFragmentPagerAdapter(FragmentManager fm) {
        mFragmentManager = fm;
    }
    ...
    public void commitUpdate() {
        if (mCurTransaction != null) {
            mCurTransaction.commitAllowingStateLoss();//.commitNowAllowingStateLoss();
            mCurTransaction = null;
        }
    }
