...
//		mCurTransaction.detach((Fragment) object);
	...
	//https://blog.csdn.net/goodlixueyong/article/details/50257079
	/*日志中显示detach的过程只执行了onPause()、onStop()和onDestroyView()三个方法，并没有执行onDestroy()和onDetach()方法，
    onCreateView
    onActivityCreated
    onStart
    onResume

	也就是说Fragment对象并没有销毁，只是从Activity中将View移除。而attach执行相反的过程*/
