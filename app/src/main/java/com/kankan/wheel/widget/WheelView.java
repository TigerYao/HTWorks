...
//			0xcfE9E9E9, 0x3fE9E9E9 };
    private int[] SHADOWS_COLORS = new int[]{0xf4f4f4f4,
            0xf4f4f4f4, 0x3fE9E9E9};
    /**
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.kankan_wheel_bg;
    private int wheelForeground = R.drawable.kankan_wheel_val;
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.main_line));
        // 设置线宽
