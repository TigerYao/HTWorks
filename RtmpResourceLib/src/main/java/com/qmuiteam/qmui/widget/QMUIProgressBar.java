...
public class QMUIProgressBar extends View {
    ...
    public static int DEFAULT_STROKE_WIDTH =40;
    ...
    public void setText(String middleText){
        this.mText=middleText;
    }

    public void setup(Context context, AttributeSet attrs) {
        DEFAULT_STROKE_WIDTH=DensityUtils.dp2px(context,40);
        mXoffset= offset=DensityUtils.dp2px(context,10);
    ...
    public void setFontType(String path){
        Typeface fontface = Typeface.createFromAsset(getContext().getAssets(),path);
    ...
    private void drawCircle(Canvas canvas) {
        ...
        if (mText != null && mText.length() > 0) {
            ...
            canvas.drawText(mText, mCenterPoint.x-mXoffset, baseline-offset, mTextPaint);
        }
    }
    ...
    public void setCurProgress(final int progress) {
      /*  if(null!=mAnimator) {
        ...
        //super.setProgress(0);
        this.mValue=0;
        long time=  Math.abs(progress-this.getProgress())*TOTAL_DURATION/mMaxValue;
