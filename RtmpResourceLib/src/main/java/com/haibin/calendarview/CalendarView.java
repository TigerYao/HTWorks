...
public class CalendarView extends FrameLayout {
    ...
    public void clearClickListener(){
        ...
        if(null!=mDelegate){
             ...
             * 日期被选中监听
             */
            mDelegate.mDateSelectedListener=null;

            /**
             * 日期选中监听
             */
            mDelegate.mCalendarSelectListener=null;

            /**
             * 外部日期长按事件
             */

            mDelegate.mDateLongClickListener=null;
             ...
             * 周视图改变事件
             */
            mDelegate.mWeekChangeListener=null;

            /**
             * 视图改变事件
             */
            mDelegate.mViewChangeListener=null;
        }
    }
    ...
    /**
     * 设置日期选中事件
     * using setOnCalendarSelectListener(OnCalendarSelectListener listener) replace
     *
    ...
    /**
     * 日期长按事件、弃用，使用以下api
     * using setOnCalendarLongClickListener(OnCalendarLongClickListener listener)
     *
     * @param listener listener
     */
    @Deprecated
    ...
    /**
     * 日期长按事件，弃用，使用以下api
     * using setOnCalendarLongClickListener(OnCalendarLongClickListener listener, boolean preventLongPressedSelect)
     *
    ...
    /**
     * 外部日期选择事件，弃用
     * using OnCalendarSelectListener
     */
    @SuppressWarnings("DeprecatedIsStillUsed")
    @Deprecated
