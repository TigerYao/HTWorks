...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected boolean mNeedlineOffset = true;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorMarginBottom = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorBottom, indicatorMarginBottom);
        ...
        mNeedlineOffset = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsLineOffset, mNeedlineOffset);
        a.recycle();
