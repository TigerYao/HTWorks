...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maxHeight = dm.heightPixels - DensityUtils.getStatusHeight(context);
        // maxHeight = dm.heightPixels;
        //setContentView(ll_top, new ViewGroup.LayoutParams(dm.widthPixels, (int) maxHeight));

        setContentView(ll_top, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public static boolean isPad(Context context) {
            int mIsPad=(context.getResources().getConfiguration().screenLayout
    ...
    public void onAttachedToWindow() {
       ...
       // Log.d(TAG, "onAttachedToWindow");
        ...
        if (widthScale == 0) {
            ...
            width =isPad(context)? DensityUtils.dp2px (context,280):(int) (dm.widthPixels * widthScale);
        }
        ...
        LinearLayout.LayoutParams tmpParams=new LinearLayout.LayoutParams(width, height);
        tmpParams.gravity=Gravity.CENTER;
        ll_control_height.setLayoutParams(tmpParams);
         ll_control_height.setGravity(Gravity.CENTER);
