...
public class ScrollLinearLayoutOld2 extends LinearLayout {
    ...
    public ScrollLinearLayoutOld2(Context context) {
        super(context);

        setInit(context);
    }

    public ScrollLinearLayoutOld2(Context context, AttributeSet attrs) {
        super(context, attrs);

        setInit(context);
    }

    public ScrollLinearLayoutOld2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
              ...
              /*      if (mState == State.RELEASE_TO_REFRESH
                    ...
                    if((getScrollY())!=0||distanceY > mTouchSlop || (distanceY>0&&(xSpeed > XSPEED_MIN))) {
                        //finish();
                        switchExpland();
