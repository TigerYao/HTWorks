...
public abstract class ScrollFrameLayout<T extends View>  extends LinearLayout {
    ...
    @SuppressLint("NewApi")
    public ScrollFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ViewCompat.postOnAnimation(ScrollFrameLayout.this, this);
            }
        }
