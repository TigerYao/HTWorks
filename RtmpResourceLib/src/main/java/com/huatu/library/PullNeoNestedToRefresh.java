...
/**
 * Created by Hale Yang on 2017/9/13.   ptr_attacher-master
 * This is an nested scroll pull to refresh view
 */

public abstract class PullNeoNestedToRefresh<E extends View> extends PullToRefreshNestBase<E> implements NestedScrollingChild, NestedScrollingParent {
    ...
    public PullNeoNestedToRefresh(Context context, PullToRefreshBase.Mode mode) {
        super(context, mode);
        init(context);
    }

    public PullNeoNestedToRefresh(Context context, PullToRefreshBase.Mode mode, AnimationStyle animStyle) {
    ...
    * */
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
       // Log.e("onNested","onNestedScroll_dy:"+dyUnconsumed+",totaUn:"+mTotalUnConmused);
        dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, mParentOffsetWindow);
        if((dxUnconsumed < 0 || dyUnconsumed < 0)//向下拉动
  ...
  //      int dy = mLastTouchY - y;
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
      //  Log.e("onNested","PreScroll_dy:"+dy+",totaUn:"+mTotalUnConmused);
//        int offset[] = new int[2];
                ...
                case VERTICAL:
                    if(dy > mTotalUnConmused) {
                      /*  consumed[1] = -mTotalUnConmused;
                        ...
                        if(dy>Math.abs(mTotalUnConmused)){
                            consumed[1] = -mTotalUnConmused;
                            mTotalUnConmused = 0;
                        }else {
                            consumed[1] = dy;
    ...
    private void pullWithNestedOver(int scrollConsumed){
      ...
      //  Log.e("onNested","NestedOver:"+scrollConsumed);
//            mCurrentMode = Mode.PULL_FROM_START;
