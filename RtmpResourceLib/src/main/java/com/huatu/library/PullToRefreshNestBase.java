...
import com.huatu.library.internal.FlipLoadingLayout;
import com.huatu.library.internal.LoadingLayout;
import com.huatu.library.internal.RotateLoadingLayout;
import com.huatu.library.internal.Utils;
...
public abstract class PullToRefreshNestBase<T extends View> extends LinearLayout implements IPullToRefresh<T>{
...
//	protected  @interface EXTRA_STATE{}
	...
	PullToRefreshBase.OnRefreshListener<T> mOnRefreshListener;
	PullToRefreshBase.OnRefreshListener2<T> mOnRefreshListener2;
...
//	private NestedScrollingChildHelper mScrollingChildHelper;
	...
	public PullToRefreshNestBase(Context context) {
		super(context);
		init(context, null);
	}

	public PullToRefreshNestBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}

	public PullToRefreshNestBase(Context context, Mode mode) {
		super(context);
		mMode = mode;
		init(context, null);
	}

	public PullToRefreshNestBase(Context context, Mode mode, AnimationStyle animStyle) {
		super(context);
		mMode = mode;
...
//	}
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			com.huatu.library.internal.ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
			mOnRefreshListener.onRefresh(null);
		} else if (null != mOnRefreshListener2) {
			if (mCurrentMode == Mode.PULL_FROM_START) {
				mOnRefreshListener2.onPullDownToRefresh(null);
			} else if (mCurrentMode == Mode.PULL_FROM_END) {
				mOnRefreshListener2.onPullUpToRefresh(null);
			}
		}
	}
		...
		*//**
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new RotateLoadingLayout(context, mode, scrollDirection, attrs,false);
				case FLIP:
					return new FlipLoadingLayout(context, mode, scrollDirection, attrs,false);
			}
		}
	}*/
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 */
		public void onPullEvent(final PullToRefreshNestBase<V> refreshView, State state, Mode direction);
...
/*	public static interface OnRefreshListener<V extends View> {
		...
		*//**
		 ...
		 * end
		 *//*
		public void onRefresh(final PullToRefreshNestBase<V> refreshView);
...
/*	public static interface OnRefreshListener2<V extends View> {
		...
		*//**
		 ...
		 *//*
		public void onPullDownToRefresh(final PullToRefreshNestBase<V> refreshView);

		*//**
		 * onPullUpToRefresh will be called only when the user has Pulled from
		 * the end, and released.
		 *//*
		public void onPullUpToRefresh(final PullToRefreshNestBase<V> refreshView);
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				ViewCompat.postOnAnimation(PullToRefreshNestBase.this, this);
			} else {
				if (null != mListener) {
