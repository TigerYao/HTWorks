...
public class PullVerRefreshRecyclerView extends PullToRefreshBase<RecyclerView> {
    public PullVerRefreshRecyclerView(Context context, Mode mode) {
        super(context, mode);
    }
    ...
    public PullVerRefreshRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullVerRefreshRecyclerView(Context context, Mode mode, AnimationStyle animStyle) {
