...
public class RotateImgLoadingLayout extends LoadingLayout {
	...
	public RotateImgLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs,boolean isCustom) {
