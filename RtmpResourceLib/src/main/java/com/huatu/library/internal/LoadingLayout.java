...
import com.huatu.library.ILoadingLayout;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	protected int inflateResId(boolean isCustom){
	    return 	isCustom ? R.layout.pull_to_refresh_header_vertical2:R.layout.pull_to_refresh_header_vertical;
	}

	public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs, boolean isCustom) {
		super(context);
		mMode = mode;
		...
		switch (scrollDirection) {
			...
			case VERTICAL:
			default:
				LayoutInflater.from(context).inflate(inflateResId(isCustom), this);
				break;
		}
	...
	public final void onPull(float scaleOfLayout) {
		if (!mUseIntrinsicAnimation||true) {
