...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context) {
		...
		mDistance=  DensityUtils.dp2px(context, 50);
/*		mTrackAnim 	= AnimationUtils.loadAnimation(context, R.anim.rail);
	...
	public void setRootViewId(int id) {
		...
		scroller		= (ViewGroup) mRootView.findViewById(R.id.scroll);
	...
	public ViewGroup getTrackContainer(){
 		return  mTrack;
	}
	...
	public void addActionItem(ActionItem action) {
		...
		TextView container	= (TextView) inflater.inflate(R.layout.action_item, null);
		...
		mTrack.addView(container);
 		if(!action.isEnd()){
			...
			line.setBackgroundColor(Color.parseColor("#4e4e4e"));
			mTrack.addView(line);
		}
	...
	public void show (View anchor) {
		...
		//boolean onTop		= (dyTop > dyBottom) ? true : false;
 		boolean onTop		= (dyTop > rootHeight+mDistance) ? true : false;
