...
package com.me.drakeet.multitype;
...
import static com.me.drakeet.multitype.Preconditions.checkNotNull;
...
public class MultiTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
  ...
  protected OnItemClickListener mOnRecyclerViewItemClickListener;

  public void performViewClick(View view,int postion,int type){
        if(null!=mOnRecyclerViewItemClickListener)
         mOnRecyclerViewItemClickListener.onItemClick(postion,view,type);
  }

  public void setOnViewItemClickListener(OnItemClickListener onRecyclerViewItemClickListener) {
