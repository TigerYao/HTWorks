...
public final class EasySnackBar extends BaseTransientBar<EasySnackBar> {
    ...
    private EasySnackBar(ViewGroup parent, View content, ContentViewCallback contentViewCallback, int top) {
    ...
    public static EasySnackBar make(@NonNull View view, @LayoutRes int layout,
                                    @Duration int duration,boolean top,CharSequence message) {

        View inflate = convertToContentView(view, layout);
        return make(view, inflate, duration,top?0:1,message);
    }

    @NonNull
    public static EasySnackBar make(@NonNull View view, @LayoutRes int layout,
                                    @Duration int duration,CharSequence message) {

        View inflate = convertToContentView(view, layout);
        return make(view, inflate, duration,2,message);
    }
    ...
    public static EasySnackBar make(@NonNull View view, @NonNull View contentView,
                                    @Duration int duration, int top,CharSequence message) {
    ...
    @NonNull
    public EasySnackBar setText(@NonNull CharSequence message) {
        final CustomContentLayout contentLayout = (CustomContentLayout) mView.getChildAt(0);
        contentLayout.setText(message);
         return this;
    }
