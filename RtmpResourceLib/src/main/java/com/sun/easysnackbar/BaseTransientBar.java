...
import static com.sun.easysnackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;

/**
 * Created by xuedakun on 2017/9/12 16:59
 *
 * @version : v1.0
 * @project : TopSnackbar
...
public abstract class BaseTransientBar<B extends BaseTransientBar<B>> {
    ...
    private final int mShowTop;// 0 top 1 bottom ,2 center

    /**
     * Base class for {@link BaseTransientBar} callbacks.
     *
    ...
    public abstract static class BaseCallback<B> {
        ...
        /**
         * Called when the given {@link BaseTransientBar} has been dismissed, either
        ...
        /**
         * Called when the given {@link BaseTransientBar} is visible.
         *
         * @param transientBottomBar The transient bottom bar which is now visible.
         * @see BaseTransientBar#show()
         */
    ...
    protected BaseTransientBar(@NonNull ViewGroup parent, @NonNull View content,
                               @NonNull ContentViewCallback contentViewCallback, int top) {
        if (parent == null) {
        ...
        if(mShowTop==0) {
            ...
            mView = (SnackbarBaseLayout) inflater.inflate(
                    R.layout.design_layout_bottom_snackbar, mTargetParent, false);
        } else {
            mView = (SnackbarBaseLayout) inflater.inflate(
                    R.layout.design_layout_center_snackbar, mTargetParent, false);
        }
    ...
    /**
     * Returns the {@link BaseTransientBar}'s context.
     */
    @NonNull
    ...
    /**
     * Returns the {@link BaseTransientBar}'s view.
     */
    @NonNull
    public View getView() {
        return mView;
    ...
    /**
     * Show the {@link BaseTransientBar}.
     */
    public void show() {
    ...
    /**
     * Dismiss the {@link BaseTransientBar}.
     */
    public void dismiss() {
    ...
    /**
     * Return whether this {@link BaseTransientBar} is currently being shown.
     */
    ...
    void animateViewOutTop(final int event) {
        if (Build.VERSION.SDK_INT >= 12) {
