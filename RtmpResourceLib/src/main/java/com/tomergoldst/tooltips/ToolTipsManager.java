...
public class ToolTipsManager {
    ...
    public ToolTipsManager(float PivotX){
        mAnimationDuration = DEFAULT_ANIM_DURATION;
        mToolTipAnimator = new DefaultToolTipAnimator(PivotX);
    }

    public ToolTipsManager(){
        mAnimationDuration = DEFAULT_ANIM_DURATION;
        mToolTipAnimator = new DefaultToolTipAnimator(0f);
    }

    public ToolTipsManager(@NonNull TipListener listener,float PivotX){
        this(PivotX);
        mListener = listener;
    }
    ...
    private TextView createTipView(ToolTip toolTip) {
       ...
       // tipView.setTextColor(toolTip.getTextGravity());
