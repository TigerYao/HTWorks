...
public class CustomConfirmDialog extends Dialog {
  ...
  /*      this.getWindow().setBackgroundDrawableResource(android.R.color.transparent);// 一句话搞定
...
//    }
    ...
    public void setNegativeButton(String text, boolean isBold, View.OnClickListener onClickListener) {
    ...
    public static class Builder {
        ...
        public Builder setNegativeButton(int stringId, View.OnClickListener onClickListener) {
        ...
        public Builder setPositiveButton(int stringId, View.OnClickListener onClickListener) {
