...
*/
     ...
     * @return
     */
    public static boolean isOpenUsageAccess(Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && isNoOptions(context)) {
            return isNoSwitch(context);
        } else {
            return true;
        }
    }
    ...
    private static boolean isNoOptions(Context context) {
