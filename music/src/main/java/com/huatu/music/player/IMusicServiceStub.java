...
public class IMusicServiceStub extends IMusicService.Stub {
 ...
 /*   @Override
    ...
    @Override
    public void play(int id,int startPos) throws RemoteException {
        mService.get().playMusic(id,startPos);
    }
    ...
    @Override
    public void setPlayRate(float playrate) throws RemoteException {
        mService.get().setPlayRate(playrate);
    }

    @Override
    public float getPlayRate() throws RemoteException {
       return   mService.get().getPlayRate();
    }
