...
public class EmojiFragment extends BaseFragment implements EmojiContract.View {
    ...
    private class EmojiAdapter extends BaseAdapter {
        ...
        private int page;
        private   final RequestOptions userDefaultAvaterOptions =
                new RequestOptions().diskCacheStrategy(DiskCacheStrategy.RESOURCE).error(R.drawable.live_ic_emotion)
                        .placeholder(R.drawable.live_ic_emotion).format(DecodeFormat.PREFER_RGB_565)
        ...
        //    Picasso.with(getContext()).load(expressionModel.getUrl()).into(holder.imageView);
            ...
            Glide.with(getContext())
                    .load(expressionModel.getUrl()).apply(userDefaultAvaterOptions)
