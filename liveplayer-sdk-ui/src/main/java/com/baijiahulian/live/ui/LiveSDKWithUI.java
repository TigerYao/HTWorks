...
public class LiveSDKWithUI {
    ...
    public static void setRoomClassEndListener(LPRoomClassEndListener listener){
        LiveRoomActivity.setRoomClassEndListener(listener);
    }
    ...
    public interface LPRoomClassEndListener{
        void onClassEnd(Context context, LPRoomExitCallback callback);
    }
